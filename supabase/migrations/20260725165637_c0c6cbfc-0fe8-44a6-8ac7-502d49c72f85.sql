...
REVOKE EXECUTE ON FUNCTION public.admin_import_iss_lvt_2022(jsonb, boolean) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.admin_import_iss_lvt_2022(jsonb, boolean) TO service_role;