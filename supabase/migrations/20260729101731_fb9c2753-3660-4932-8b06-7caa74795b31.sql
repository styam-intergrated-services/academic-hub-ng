CREATE OR REPLACE FUNCTION public.admin_bulk_import_results(
  _payload jsonb,
...
REVOKE ALL ON FUNCTION public.admin_bulk_import_results(jsonb, boolean) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.admin_bulk_import_results(jsonb, boolean) TO authenticated;